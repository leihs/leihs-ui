...
const exampleProps1 = {
  list: [
    ...
    },
    {
      ...
      isDimmed: true,
      subCaption: 'Sony',
      imgSrc: require('../../static/example-images/models/43cd9671-8ab2-5960-8426-4f9b235b449d.jpg').default
    },
    {
      ...
      subCaption: 'Sony',
      imgSrc: require('../../static/example-images/models/4d446da0-81ae-5dd4-a2b0-f9adae2de0d4.jpg').default
    },
    {
      ...
      subCaption: 'Sony',
      imgSrc: require('../../static/example-images/models/8e17238d-9ee2-402c-a469-20300d7b08fc.jpg').default
    },
    {
      ...
      isDimmed: true,
      subCaption: 'Sony',
      imgSrc: require('../../static/example-images/models/ad8a36fd-1bec-5be5-a702-326e4e49d756.jpg').default
    }
  ]
}
