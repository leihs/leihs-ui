  ...
  return (
    <>
      ...
      <p className="text-muted">
        The status summary can consist of up to 3 <b>status lines</b>, one for each sub process:{' '}
        <b>approval, pick-up and return</b>
      </p>
      <p className="text-muted">Example where all 3 status lines are shown:</p>
      <Example>
        <ProgressInfo
      ...
      <h3>2</h3>
      <p className="text-muted">
        Status lines generally are shown for sub processes being <b>in progress</b> only.
      </p>
      <p className="text-muted">
        In the following example, only the pick-up status line is shown. Approval is not in progress anymore (all items
        were approved). Return is not in progress yet (no item was picked up yet):
      </p>
      <Example>
        <ProgressInfo
          title={statusLabels.TO_PICKUP}
      ...
      <h3>3</h3>
      <p className="text-muted">
        When a rental has ended, a plain title for the terminal status is displayed, with these 4 possibilities:
      </p>
      ...
      <h3>4</h3>
      <p className="text-muted">
        &quot;Drop-out items&quot; - when the sub process reduced the number of items for the next sub process, the
        reason is mentioned in parantheses.
      </p>
      ...
      <p className="text-muted">
        In the case of &quot;drop-out items&quot; the status line is shown even when the sub process is completed.
    ...
    <>
      ...
      <p className="text-muted">
        ...
        <span className="fw-light">
          Only the approval status line is shown because pick-up and return sub process have not been started yet.
        </span>
      </p>
      <Example>
        <ProgressInfo
      ...
      <p className="text-muted">
        ...
        <span className="fw-light">
          The pick-up sub process has started. The status line for approval is now hidden because the sub process is
          complete.
        </span>
      </p>
      <Example>
      ...
      <p className="text-muted">
        ...
        <span className="fw-light">The return sub process has started, the pick-up sub process is ongoing.</span>
      </p>
      <Example>
        <ProgressInfo
          title={statusLabels.TO_PICKUP}
...
export function detailsPickup() {
  return (
    <>
      ...
      <p className="text-muted">
        (Note how the pick-up summary is still shown because its affects the next process by reducing total number of
        items to return)
      </p>
