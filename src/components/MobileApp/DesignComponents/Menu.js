...
export default function Menu({ children, className, ...restProps }) {
  return (
    <div className={cx('bg-light-shade', className)} {...restProps}>
      <nav
        className="py-5 page-inset-x container-fluid d-flex flex-column justify-content-between flex-md-row gap-5"
